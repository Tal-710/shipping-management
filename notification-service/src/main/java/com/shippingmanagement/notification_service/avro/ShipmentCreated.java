 ...
 */
package com.shippingmanagement.notification_service.avro;
...
static {
  ...
  public static ShipmentCreated fromByteBuffer(
   ...
   private CharSequence shipmentId;
   private int orderId;
   private CharSequence customerId;
   private CharSequence destinationCountry;
   private int shipId;
   ...
   */
  public ShipmentCreated(CharSequence shipmentId, Integer orderId, CharSequence customerId, CharSequence destinationCountry, Integer shipId, java.time.Instant departureDate, java.time.Instant createdAt) {
  ...
  public void put(int field$, Object value$) {
    switch (field$) {
    case 0: shipmentId = (CharSequence)value$; break;
    case 1: orderId = (Integer)value$; break;
    case 2: customerId = (CharSequence)value$; break;
    case 3: destinationCountry = (CharSequence)value$; break;
    case 4: shipId = (Integer)value$; break;
   ...
   */
  public CharSequence getShipmentId() {
    return shipmentId;
  }
   ...
   */
  public void setShipmentId(CharSequence value) {
   ...
   */
  public CharSequence getDestinationCountry() {
   ...
   * @param value the value to set.
   */
  public void setDestinationCountry(CharSequence value) {
   ...
   * @return A new ShipmentCreated RecordBuilder
   */
  public static Builder newBuilder(ShipmentCreated other) {
    if (other == null) {
      return new Builder();
    } else {
      return new Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<ShipmentCreated>
     ...
     * @param other The existing instance to copy.
     */
    private Builder(ShipmentCreated other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.shipmentId)) {
        this.shipmentId = data().deepCopy(fields()[0].schema(), other.shipmentId);
    ...
    /**
      ...
      * @return This builder.
      */
    public Builder setShipmentId(CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public Builder setDestinationCountry(CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public Builder setDepartureDate(java.time.Instant value) {
    ...
    public ShipmentCreated build() {
      try {
        ...
        record.shipmentId = fieldSetFlags()[0] ? this.shipmentId : (CharSequence) defaultValue(fields()[0]);
        record.orderId = fieldSetFlags()[1] ? this.orderId : (Integer) defaultValue(fields()[1]);
        record.customerId = fieldSetFlags()[2] ? this.customerId : (CharSequence) defaultValue(fields()[2]);
        record.destinationCountry = fieldSetFlags()[3] ? this.destinationCountry : (CharSequence) defaultValue(fields()[3]);
        record.shipId = fieldSetFlags()[4] ? this.shipId : (Integer) defaultValue(fields()[4]);
